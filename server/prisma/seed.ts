...
async function main() {
    ...
    const sampleArticles = [
        ...
        {
            title: 'مهرجان عدن للفنون يستقطب آلاف الزوار',
            slug: 'sanaa-arts-festival-attracts-thousands',
            excerpt: 'اختتم مهرجان عدن الدولي للفنون فعالياته بنجاح كبير بعد استقطابه أكثر من 50 ألف زائر',
            content: '<p>اختتم مهرجان عدن الدولي للفنون التشكيلية فعالياته بنجاح كبير، بعد أن استقطب أكثر من 50 ألف زائر من مختلف المحافظات.</p><p>شارك في المهرجان أكثر من 200 فنان من 15 دولة عربية وأجنبية، قدموا أعمالاً فنية متنوعة في الرسم والنحت والتصوير الفوتوغرافي.</p>',
