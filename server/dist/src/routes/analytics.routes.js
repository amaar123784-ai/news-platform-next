...
router.get('/stats', async (req, res, next) => {
    try {
        ...
        const [totalViews, totalArticles, totalUsers, totalComments, lastMonthArticles, prevMonthArticles, lastMonthUsers, prevMonthUsers, lastMonthComments, prevMonthComments,] = await Promise.all([
