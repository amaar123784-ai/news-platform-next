...
let storeOption = undefined; // undefined = use default MemoryStore
async function initRedisStore() {
    ...
    try {
        ...
        const client = new Redis(process.env.REDIS_URL || `redis://${process.env.REDIS_HOST}:${process.env.REDIS_PORT || 6379}`, {
