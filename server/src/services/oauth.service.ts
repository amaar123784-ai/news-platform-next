 ...
 */
export async function verifyGoogleToken(token: string): Promise<SocialProfile | null> {
    try {
 ...
 */
export async function verifyFacebookToken(token: string): Promise<SocialProfile | null> {
    try {
