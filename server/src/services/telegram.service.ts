...
class TelegramService {
    ...
    public async sendArticleToTelegram(article: any): Promise<boolean> {
        if (!this.isEnabled || !this.botToken || !this.channelId) return false;
    ...
    public async sendArticleWithPhoto(article: any): Promise<boolean> {
        if (!this.isEnabled || !this.botToken || !this.channelId) return false;
